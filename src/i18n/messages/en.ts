export const en = {
  ...
  hero: {
    ...
    eyebrow: "Premium Real Estate Ecosystem",
    title: "Kera Group — Full-Service Real Estate",
    subtitle:
      "Real Estate · Development · Investment · Property Management · Media — one premium platform.",
    propertyType: "Property type",
    location: "Location",
    locationPlaceholder: "e.g. Vake, Batumi...",
    bedrooms: "Bedrooms",
    minPrice: "Min. price",
    maxPrice: "Max. price",
    search: "Search",
